      ...
      body: Stack(
        children: [
          ...
          onLoadStart: (controller, url) async {
            ...
            // 🔄 Limpar cache quando receber parâmetro refresh (notificação push)
            if (url != null && url.toString().contains('refresh=')) {
              print('🔄 Detectado parâmetro refresh - limpando cache do WebView...');
              await controller.clearCache();
              print('✅ Cache do WebView limpo com sucesso');
            }
          },
